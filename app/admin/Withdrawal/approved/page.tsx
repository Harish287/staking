...
export default function ApprovedWithdrawRequests() {
  ...
  useEffect(() => {
    dispatch(
      fetchWithdrawList({ review_status: 'approved', page: 1, page_size: 10 }),
    )
  }, [dispatch])
                ...
                <TableRow key={item.withdraw_request_id}>
                  ...
                  <TableCell>
                    <div className=' flex items-center'>
                      ...
                      />
                      <span className=' ml-0.5'> {item.amount.toLocaleString('en-IN')}</span>
                    </div>
                  </TableCell>
